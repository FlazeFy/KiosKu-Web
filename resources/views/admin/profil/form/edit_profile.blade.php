<div class="card shadow my-3">
    ...
    <div class="card-body p-4">
        ...
        @else 
            <div class="row">
                ...
                <div class="col-lg-11 col-md-9 col-sm-12 pt-2">
                    <h6>{{$ak->nama_kios}}</h6>
                    <h6>{{$ak->alamat_kios}}</h6>
                    <h6>{{$ak->kontak_kios}} / {{$ak->email_kios}}</h6>
                </div>
            </div>
        @endif
    </div>
    ...
    <div class="card-body p-4">
        ...
        @elseif(session()->get('role') == "karyawan")
            @foreach($akun_karyawan as $akk)
                <form method="POST" action="profil/edit">
                    @csrf
                    <input name="username_old" value="{{$akk->username_karyawan}}" hidden>
                    <div class="row">
                        <div class="mb-3 col-md-6">
                            <div class="form-floating mb-2">
                                <input type="username" class="form-control" name="username" value="{{$akk->username_karyawan}}" required>
                                <label for="floatingInput">Username</label>
                            </div>
                        </div>
                        <div class="mb-3 col-md-6">
                            <div class="form-floating mb-2">
                                <input type="password" class="form-control" name="password" value="{{$akk->password_karyawan}}" required>
                                <label for="floatingInput">Password</label>
                            </div>
                        </div>
                        <div class="mb-3 col-md-6">
                            <div class="form-floating mb-2">
                                <input type="text" class="form-control" name="nama_karyawan" value="{{$akk->nama_karyawan}}" required>
                                <label for="floatingInput">Nama Karyawan</label>
                            </div>
                        </div>
                        <div class="mb-3 col-md-6">
                            <div class="form-floating mb-2">
                                <input type="text" class="form-control" name="nama_lengkap_karyawan" value="{{$akk->nama_lengkap_karyawan}}" required>
                                <label for="floatingInput">Nama Lengkap Karyawan</label>
                            </div>
                        </div>
                        <div class="mb-3 col-md-6">
                            <div class="form-floating mb-2">
                                <input type="phone" class="form-control" name="ponsel_karyawan" value="{{$akk->ponsel_karyawan}}">
                                <label for="floatingInput">Kontak</label>
                            </div>
                        </div>
                        <div class="mb-3 col-md-6">
                            <div class="form-floating mb-2">
                                <input type="email" class="form-control" name="email_karyawan" value="{{$akk->email_karyawan}}" required>
                                <label for="floatingInput">Email</label>
                            </div>
                        </div>
                    </div>
